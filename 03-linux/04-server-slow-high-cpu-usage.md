...
If the server is a production critical server I would identify the process and either kill it if its not important or use nice/renice to decrease its priority.
